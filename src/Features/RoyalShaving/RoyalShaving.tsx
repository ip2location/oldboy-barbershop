    ...
    <div>
      ...
      >
        ...
        >
          ...
          Труфита получила эксклюзивные привилегии королевского двора. Тогда же были заложены основы
      ...
      <StageSection variant="rowReverse">
        ...
        >
          <p className="text-lg font-button_font leading-[1.75] text-header-bg">
            В специальном паровом шкафу ждут своего времени разогретые махровые полотенца. Идеально
            подобранная температура и влажность не нанесут вашей коже ожогов или дискомфорта,
            но&nbsp;подготовят бороду к бритью.
          </p>
          <p className="text-lg font-button_font leading-[1.75] text-header-bg">
            Кожа очищается, раскрываются поры, щетина размягчается. Приливающая кровь приподнимает
            волоски, которые под горячим компрессом становятся мягче и прямее, благодаря чему бритьё
            будет чище и безопаснее. Распаривание значительно снижает уровень раздражения
      ...
      <StageSection variant="row">
        ...
        >
          ...
          <p className="text-lg font-button_font leading-[1.75] text-orange-bg font-bold">
            ...
            из&nbsp;уникальной шерсти барсука класса &ldquo;Silvertip&rdquo;. Её нежнейшие волоски,
            собираемые с&nbsp;небольшого участка в области шеи животного, отлично удерживают влагу и
            создают пену необходимой консистенции.
          </p>
          <p className="text-lg font-button_font leading-[1.75] text-header-bg">
      ...
      <StageSection variant="rowReverse">
        ...
        >
          <p className="text-lg font-button_font leading-[1.75] text-header-bg">
            ...
            бритвой требует немалого опыта, и мы гордимся, что наши специалисты достигли в этом деле
          ...
          <p className="text-lg font-button_font leading-[1.75] text-header-bg">
            Барбер натягивает кожу там, где это необходимо и именно с тем усилием, которое требуется
            на&nbsp;каждом участке лица. Максимально острое лезвие бритвы, подчиняясь ювелирным
            движениям руки мастера, под необходимым углом скользит по коже, гладко и начисто срезая
            волоски.
          </p>
        </StageContent>
      </StageSection>
